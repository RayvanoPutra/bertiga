...
class Kelas extends Model
{
    ...
    // Asumsi di migration TahunAjaran menggunakan 'kode_tahun_ajaran' sebagai PK
    ...
    // Tambahkan relasi ke Nasabah jika ada
    public function nasabah(): HasMany
    {
        return $this->hasMany(Nasabah::class, 'kode_kelas', 'kode_kelas'); 
    }
}