...
Route::get('/user', function (Request $request) {
    ...
    // Jika user adalah Nasabah, kita ambil data segarnya dari tabel 'nasabah'
    // menggunakan no_rekening (karena itu PK Anda di migrasi)
    if ($user instanceof \App\Models\Nasabah) {
        return \App\Models\Nasabah::where('no_rekening', $user->no_rekening)->first();
    }
    
    // Fallback (jika bukan nasabah, misal petugas)
    return $user;
});
